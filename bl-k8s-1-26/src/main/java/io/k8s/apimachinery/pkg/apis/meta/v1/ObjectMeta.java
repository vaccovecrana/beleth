...
public class ObjectMeta {
    ...
    public ObjectMeta withAnnotations(Annotations annotations) {
    ...
    public ObjectMeta withFinalizers(List<String> finalizers) {
    ...
    public ObjectMeta withLabels(Labels labels) {
        this.labels = labels;
        return this;
    }
