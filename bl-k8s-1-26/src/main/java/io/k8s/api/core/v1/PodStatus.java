...
import io.k8s.api.core.v1.podstatus.Phase;
import io.k8s.api.core.v1.podstatus.QosClass;
...
public class PodStatus {
   ...
   */
  public PodStatus phase(Phase phase) {
    this.phase = phase;
    return this;
  }
   ...
   */
  public PodStatus qosClass(QosClass qosClass) {
