...
import io.k8s.api.core.v1.podspec.DnsPolicy;
import io.k8s.api.core.v1.podspec.NodeSelector;
import io.k8s.api.core.v1.podspec.Overhead;
import io.k8s.api.core.v1.podspec.RestartPolicy;
...
public class PodSpec {
   ...
   */
  public PodSpec dnsPolicy(DnsPolicy dnsPolicy) {
   ...
   */
  public PodSpec resourceClaims(List<PodResourceClaim> resourceClaims) {
   ...
   *  - `&#34;OnFailure&#34;`
   */
  public PodSpec restartPolicy(RestartPolicy restartPolicy) {
   ...
   */
  public PodSpec schedulingGates(List<PodSchedulingGate> schedulingGates) {
