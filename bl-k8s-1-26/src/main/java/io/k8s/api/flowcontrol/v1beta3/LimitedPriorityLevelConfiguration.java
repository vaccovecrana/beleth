...
public class LimitedPriorityLevelConfiguration {
     ...
     * 
     */
    public Integer borrowingLimitPercent;
    /**
     ...
     * 
     */
    public Integer lendablePercent;
    /**
     ...
     * 
     */
    public Integer nominalConcurrencyShares;

    public LimitedPriorityLevelConfiguration withBorrowingLimitPercent(Integer borrowingLimitPercent) {
        this.borrowingLimitPercent = borrowingLimitPercent;
        return this;
    }

    public LimitedPriorityLevelConfiguration withLendablePercent(Integer lendablePercent) {
    ...
    public LimitedPriorityLevelConfiguration withNominalConcurrencyShares(Integer nominalConcurrencyShares) {
