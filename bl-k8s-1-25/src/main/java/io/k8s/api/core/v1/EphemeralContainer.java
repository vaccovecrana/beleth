...
import io.k8s.api.core.v1.ephemeralcontainer.ImagePullPolicy;
import io.k8s.api.core.v1.ephemeralcontainer.TerminationMessagePolicy;
...
public class EphemeralContainer {
  ...
  public TerminationMessagePolicy terminationMessagePolicy;
   ...
   */
  public EphemeralContainer imagePullPolicy(ImagePullPolicy imagePullPolicy) {
   ...
   */
  public EphemeralContainer terminationMessagePolicy(
