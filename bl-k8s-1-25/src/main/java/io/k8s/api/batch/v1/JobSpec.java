...
public class JobSpec {
    ...
    public JobSpec withActiveDeadlineSeconds(Integer activeDeadlineSeconds) {
    ...
    public JobSpec withCompletionMode(String completionMode) {
    ...
    public JobSpec withManualSelector(Boolean manualSelector) {
    ...
    public JobSpec withSelector(LabelSelector selector) {
        this.selector = selector;
        return this;
    }

    public JobSpec withSuspend(Boolean suspend) {
        this.suspend = suspend;
        return this;
    }

    public JobSpec withTemplate(PodTemplateSpec template) {
