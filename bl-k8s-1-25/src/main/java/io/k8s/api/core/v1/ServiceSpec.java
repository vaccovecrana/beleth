...
import io.k8s.api.core.v1.servicespec.ExternalTrafficPolicy;
import io.k8s.api.core.v1.servicespec.Selector;
import io.k8s.api.core.v1.servicespec.SessionAffinity;
import io.k8s.api.core.v1.servicespec.Type;
...
public class ServiceSpec {
  ...
  public ExternalTrafficPolicy externalTrafficPolicy;
   ...
   */
  public ServiceSpec externalTrafficPolicy(ExternalTrafficPolicy externalTrafficPolicy) {
   ...
   */
  public ServiceSpec sessionAffinity(SessionAffinity sessionAffinity) {
   ...
   */
  public ServiceSpec type(Type type) {
    this.type = type;
    return this;
  }
}
