...
import io.k8s.api.batch.v1.podfailurepolicyonexitcodesrequirement.Operator;
...
public class PodFailurePolicyOnExitCodesRequirement {
   ...
   *  - `&#34;NotIn&#34;`
   */
  public PodFailurePolicyOnExitCodesRequirement operator(Operator operator) {
   ...
   */
  public PodFailurePolicyOnExitCodesRequirement values(List<Long> values) {
    this.values = values;
    return this;
  }
}
