 ...
 */
public class ClusterTrustBundleSpec {
   ...
   */
  public ClusterTrustBundleSpec signerName(String signerName) {
   ...
   */
  public ClusterTrustBundleSpec trustBundle(String trustBundle) {
