...
public class ContainerStatus {
   ...
   */
  public ContainerStatus allocatedResourcesStatus(List<ResourceStatus> allocatedResourcesStatus) {
  ...
  public ContainerStatus user(ContainerUser user) {
    this.user = user;
    return this;
  }
   ...
   */
  public ContainerStatus volumeMounts(List<VolumeMountStatus> volumeMounts) {
