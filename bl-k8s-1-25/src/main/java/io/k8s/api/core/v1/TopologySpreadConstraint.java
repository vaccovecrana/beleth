...
public class TopologySpreadConstraint {
     ...
     * 
     */
    public TopologySpreadConstraint.WhenUnsatisfiable whenUnsatisfiable;
    ...
    public TopologySpreadConstraint withWhenUnsatisfiable(TopologySpreadConstraint.WhenUnsatisfiable whenUnsatisfiable) {
    ...
    public enum WhenUnsatisfiable {
        ...
        private final static Map<String, TopologySpreadConstraint.WhenUnsatisfiable> CONSTANTS = new HashMap<String, TopologySpreadConstraint.WhenUnsatisfiable>();

        static {
            for (TopologySpreadConstraint.WhenUnsatisfiable c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        WhenUnsatisfiable(String value) {
            this.value = value;
        }
        ...
        public static TopologySpreadConstraint.WhenUnsatisfiable fromValue(String value) {
            TopologySpreadConstraint.WhenUnsatisfiable constant = CONSTANTS.get(value);
            if (constant == null) {
