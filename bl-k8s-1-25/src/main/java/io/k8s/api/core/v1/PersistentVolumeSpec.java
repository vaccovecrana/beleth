...
import io.k8s.api.core.v1.persistentvolumespec.PersistentVolumeReclaimPolicy;
...
public class PersistentVolumeSpec {
  ...
  public PersistentVolumeReclaimPolicy persistentVolumeReclaimPolicy;
   ...
   */
  public PersistentVolumeSpec persistentVolumeReclaimPolicy(
