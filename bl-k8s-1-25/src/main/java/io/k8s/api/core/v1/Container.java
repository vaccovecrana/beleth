...
import io.k8s.api.core.v1.container.TerminationMessagePolicy;
...
public class Container {
   ...
   */
  public Container imagePullPolicy(ImagePullPolicy imagePullPolicy) {
   ...
   */
  public Container terminationMessagePolicy(TerminationMessagePolicy terminationMessagePolicy) {
